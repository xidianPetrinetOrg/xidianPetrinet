 ...
 */
public class PTNetGraph2 implements ActionListener, ItemListener {
	/** 输出状态信息 */
    ...
    */
    ...
    public PTNetGraph2() {
        ...
        frame = new JFrame("PTNet and MarkingGraph");
    	frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    	
    	// menuBar, ptnet graph and it's marking graph共用
...
//		undoManager.addListener(mxEvent.REDO, undoHandler);
     ...
     * @param ptnet PTNet对象
     */
    public PTNetGraph2(PTNet ptnet) {
    	this.ptNet = ptnet;
    ...
    public void graphComponent() {
    	...
    	try {
    		...
    		IMarkingGraphReady ready = new IMarkingGraphReady() {
    			...
    			public void graph(boolean isReady) {
    				...
    				if(isReady) {
    					//System.out.println(ptMarkingGraphComponent);
    					System.out.println("frame3:"+frame.getComponentCount());
    			    	System.out.println("framepane3:"+frame.getContentPane().getComponentCount());
    				}
    				// TODO：ptMarkingGraphComponent的undo
    			}
    		};
    	...
    	System.out.println("frame:"+frame.getComponentCount());
    	System.out.println("framepane:"+frame.getContentPane().getComponentCount());
    	// 改变petri net后，去掉老的ptnet graph及其marking graph
    	if (frame.getContentPane().getComponentCount() > 0) {
    		frame.getContentPane().removeAll();
    	}
        frame.setContentPane(addComponentsToPane());
        System.out.println("frame1:"+frame.getComponentCount());
     	System.out.println("framepane1:"+frame.getContentPane().getComponentCount());
    ...
    /** 生成菜单条MenuBar，ptnet graph and it's marking graph共用 */
...
//			}
	...
	private static ImageIcon createNavigationIcon(String imageName) {
		...
		java.net.URL imageURL = PTNetGraph2.class.getResource(imgLocation);
    ...
    public static void createAndShowGUI(PTNet ptnet) {		
    	...
    	PTNetGraph2 ptgraph = new PTNetGraph2(ptnet);
