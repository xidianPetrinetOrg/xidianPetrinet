...
public class S2PRTest {
	...
	public void hasCycle1() {
		...
		try {
			System.out.println("p1是t1的前继：" + TraversalUtils.isPredecessor(ptnet1, ptnet1.getPlace("p1"), ptnet1.getTransition("t1")));
		...
		try {
			System.out.println("p1是t2的前继：" + TraversalUtils.isPredecessor(ptnet1, ptnet1.getPlace("p1"), ptnet1.getTransition("t2")));
		} catch (ParameterException | VertexNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			System.out.println("p1是t1的后继：" + TraversalUtils.isSuccessor(ptnet1, ptnet1.getPlace("p1"), ptnet1.getTransition("t1")));
		} catch (ParameterException | VertexNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			System.out.println("p1是t2的后继：" + TraversalUtils.isSuccessor(ptnet1, ptnet1.getPlace("p1"), ptnet1.getTransition("t2")));
		} catch (ParameterException | VertexNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void hasCycle2() {
		...
		ptnet1.addPlace("p3");
		ptnet1.addFlowRelationPT("p3", "t1");
		ptnet1.addFlowRelationTP("t2", "p3");
